...
<div class="w3-padding">
    <div class="w3-bar-block w3-text-white">
        <div class="w3-bar-block w3-text-white ">
            ...
            <a href="training.php" class="w3-bar-item dasHover w3-round <?php echo $m_training;?>"><i class="fa fa-user w3-xlarge w3-margin-right"></i><span class="w3-center"> Training</span></a>
            <?php
