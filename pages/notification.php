        ...
        <table class="w3-table-all w3-hoverable w3-border-0">
            ...
            <tr>                
                ...
                <?php 
                    ...
                    echo    "<td>".statecase($item['statecase'])."</td>
                            <td>".$item['dateassign']."</td>";
                ?>
                <td class="w3-row">
                    <a class="w3-button w3-padding s3 l3 m3 w3-xlarge w3-text-blue" href="#"><i class="fa fa-thumbs-up"></i></a>
                    <a class="w3-button w3-padding s3 l3 m3 w3-xlarge w3-text-yellow" href="#"><i class="fa fa-thumbs-down"></i></a>
                    <a class="w3-button w3-padding s3 l3 m3 w3-xlarge w3-text-red" href="#"><i class="fa fa-trash"></i></a>                    
                </td>
            </tr>                        
            <?php
                    $n++;
