    ...
    <div class="">
        <div class="w3-sidebar w3-bar-block w3-light-grey w3-card dasheader dash-side-menu w3-hide-small" >
            ...
            <div class="w3-padding">
                    <div class="w3-bar-block w3-text-white ">
                            ...
                            <a href="message.html" class="w3-bar-item dasHover w3-round active"><i class="fa fa-envelope w3-xlarge w3-margin-right"></i><span class="w3-center"> Message</span></a>
        ...
        <div class="dash-containt">
            <div class="w3-bar w3-white  top-bar" style="padding-right:20px;">
                ...
                <div class="w3-right"> 
                    <a href="../index.html" class="w3-bar-item w3-text-red w3-btn w3-large">LogOut</a>
